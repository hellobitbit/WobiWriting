...
public class SearchSpeakCNActivity extends ActionBarActivity
        implements SpeakTypeAdapter.OnRecyclerViewItemClickListener,
        SpeakSZAdapter.OnRecyclerViewItemClickListener{
...
//        }
    ...
    private void initVideo(){
        ...
        mVideoView.setVideoViewCallback(new UniversalVideoView.VideoViewCallback() {
            ...
            public void onScaleChange(boolean isFullscreen) {
                SearchSpeakCNActivity.this.isFullscreen = isFullscreen;
                if (isFullscreen) {
    ...
    public void onBackPressed() {
        if (SearchSpeakCNActivity.this.isFullscreen) {
