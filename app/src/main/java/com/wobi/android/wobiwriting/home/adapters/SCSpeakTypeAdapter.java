...
/**
 * Created by wangyingren on 2017/12/1.
 */

public class SCSpeakTypeAdapter extends RecyclerView.Adapter<SCSpeakTypeAdapter.SelectedTypeHolder> {
    ...
    public void setOnItemClickListener(SpeakTypeAdapter.OnRecyclerViewItemClickListener listener) {
    ...
    public SCSpeakTypeAdapter(Context context, boolean isSc) {
        this.mContext = context;
        this.mInflater = LayoutInflater.from(mContext);
        this.isSc = isSc;
        initDatas();
    ...
    public SelectedTypeHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SelectedTypeHolder(mInflater.inflate(R.layout.sc_speak_type_item_layout,
                parent, false));
    }
